...
class Trainer:
    ...
    def setup_agent(self):
        if self.args.self_play and self.args.sp_mode == 1 and self.args.sp_agent_checkpoint:
    ...
    def evaluate_win_rate(self, agent, opponent, eval_episodes=10, render=False):
        """
